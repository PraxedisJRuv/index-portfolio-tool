...
from modules.extraction import full_dataframe_extraction, index_dataframe_extraction
import modules.benchmarks as bm
import modules.portfolio as port
from modules.optimization.Clustering.medoids.kmedoids import clustering_medoids
from modules.optimization.Markowitz.usual.markowitz import markowitz,markowitz_of_periods
...
df = pd.read_csv("C:/Users/praxy/OneDrive/Escritorio/Progra/Tests_for_live_index/resources/temporal.csv", index_col=0, parse_dates=True)
index=pd.read_csv("C:/Users/praxy/OneDrive/Escritorio/Progra/Tests_for_live_index/resources/index_t.csv", index_col=0, parse_dates=True)
