...
portfolio=port.general_portfolio_values(df,period,tickers)
print(portfolio)
print(port.general_portfolio_returns(portfolio,period))
correlation=port.general_metrizised_correlation_matrix(df,period,tickers)
print(correlation)
